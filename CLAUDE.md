...
- **Card text stat notation** (locked 2026-04-08): Use 🗡️ (dagger) for **attack** and ❤️ (heart) for **HP/health** in all player-facing text. Applies uniformly to both minion health and player life pool — one glyph, reads clearer. Examples: `+5🗡️`, `+5❤️`, `+1🗡️/+1❤️`, `3🗡️/8❤️`, `player takes 5❤️ damage`, `0❤️ = defeat`. Do NOT use words like "attack"/"ATK"/"HP" or the shield emoji (🛡️) — shield was used briefly on 2026-04-07 and replaced with ❤️ for clarity. Engine field names (`attack`, `health`, `hp`, `attack_bonus`) stay as-is.
