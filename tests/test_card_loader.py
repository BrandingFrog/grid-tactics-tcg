...
class TestPhase1473NewTriggers:
    ...
    def test_all_dark_mages_grant_dark_matter_on_summon(self, real_library) -> None:
        ...
        Composite tribes count as Dark Mages since the same day — 7 total
        (Eclipse Shade, Erebus, Gargoyle Sorceress, Matter Possessed,
        Shadow Blaster, Ratchanter, Grave Caller)."""
        ...
        assert len(dark_mages) == 7, [c.card_id for c in dark_mages]
