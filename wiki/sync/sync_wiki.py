...
def main(argv: list[str] | None = None) -> int:
    ...
    if args.polish:
        ...
        print("\n=== Header Bar ===")
        hdr_css_status = push_header_bar_css(site, dry_run=args.dry_run)
        hdr_js_status = push_header_bar_js(site, dry_run=args.dry_run)
        ...
        print(f"\nPolish complete: CSS={css_status}, Logo={logo_status}, "
              ...
              f"HeaderBar={hdr_css_status}/{hdr_js_status}")
        return 0
