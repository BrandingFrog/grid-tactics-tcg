...
RULES_PAGES: dict[str, str] = {
    ...
    "Grave": (
        ...
        "enters the owner's grave.\n"
        "* '''[[Conjure]]d minions''' -- Conjured minions originated from "
        "the deck. When they die, they enter the grave like any other "
        "minion.\n"
        "* '''[[Sacrifice]]''' -- When a minion is sacrificed at "
        "the opponent's back row, its card enters the owner's grave.\n"
        "\n"
        "== When Cards Do NOT Enter the Grave ==\n"
        "* '''Tokens''' -- Minions spawned by activated abilities were "
        "never in the deck. When they die, they are removed from the "
        "game entirely and do not enter any pile.\n"
        "* '''[[Exhaust]] costs''' -- Cards removed from hand as a cost "
        "(e.g. [[Cost]]: [[Exhaust]] any Robot) enter the "
    ...
    "Sacrifice": (
        ...
        "# The minion's card enters the owner's [[Grave]].\n"
    ...
    "Combat": (
        ...
        "HP reaches 0, the minion dies and is removed from the board. "
        "Its card enters the owner's [[Grave]].\n"
        "\n"
        "== See Also ==\n"
        "* [[Melee]]\n"
        "* [[Ranged]]\n"
