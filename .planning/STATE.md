...
Phase: 14.8 (phase-contract-enforcement) — IN PROGRESS (Plans 01 + 02 SHIPPED 2026-04-21)
Plan: 02 of ~7 (pytest invariant + drive shadow violations to zero + conftest shadow default) — COMPLETE
Next: 14.8-03a (event emitter — uses contract_source as event tag; the now-correct sources flow through cleanly)
