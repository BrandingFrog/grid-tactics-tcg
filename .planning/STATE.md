...
Phase: 14.8 (phase-contract-enforcement) — IN PROGRESS (Plan 01 SHIPPED 2026-04-21)
Plan: 01 of ~7 (foundation: PHASE_CONTRACTS table + OutOfPhaseError + 53 tagged call sites) — COMPLETE
Next: 14.8-02 (pytest invariant test that scans every card × every phase, drives shadow-mode warnings to zero)
